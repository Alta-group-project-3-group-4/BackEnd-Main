...
func (_m *CommentData) Add(newComment comment.Core) error {
...
func (_m *CommentData) Delete(userId uint, id uint) error {
...
func (_m *CommentData) GetHomestayComments(homeId uint) ([]comment.Core, error) {
