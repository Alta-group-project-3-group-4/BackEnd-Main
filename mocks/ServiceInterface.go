...
func (_m *ServiceInterface) Create(input homestay.HomestayEntity) error {
	ret := _m.Called(input)
...
func (_m *ServiceInterface) Delete(id int) error {
	ret := _m.Called(id)
...
func (_m *ServiceInterface) GetAll() ([]homestay.HomestayEntity, error) {
	ret := _m.Called()
...
func (_m *ServiceInterface) GetUserHome(id uint) (homestay.HomestayEntity, error) {
	ret := _m.Called(id)
...
func (_m *ServiceInterface) Update(id int, input homestay.HomestayEntity) error {
